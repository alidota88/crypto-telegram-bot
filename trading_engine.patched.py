...
main_strategy = MultiTFMidtermStrategy()       # 原 MACD+RSI 多周期策略
...
def run_strategy_and_update_positions() -> tuple[str, List[str]]:
    ...
    for symbol in TRADE_SYMBOLS:
        try:
            ...
            # 3) 用简单策略信号做交易
            trade_signal = simple_last_signal if (simple_last_signal != 0 and simple_last_signal == main_last_signal) else 0  # 与主趋势同向才交易
